...
public class SendEmailThread implements Runnable{
    ...
    private final static String USER = "grupo07sc@tecnoweb.org.bo";
    ...
    private final static String USER = "rikrdoramirez1993@gmail.com";
    private final static String MAIL = "rikrdoramirez1993@gmail.com";
    private final static String MAIL_PASSWORD = "wgyvheoeupxjzedl";
    */
    ...
    public void run() {
        ...
        properties.setProperty("mail.smtp.auth.mechanisms", "false");//tecnoweb
//        properties.setProperty("mail.smtp.auth", "false");//gmail
